...
export default function Textform(props) {
  ...
  return (
      ...
      <h2>{props.heading} </h2>
      <textarea className="form-control" placeholder="Enter Text Here"   onChange={handleonchange} style={{backgroundColor: props.mode==='dark'?'#889cb5':'white', color: props.mode==='dark'?'white':'black'}} id="myBox" rows="8"></textarea>
      </div>
